...
;;The function defined can even work if any other professor with different slip
;;color needs to remove duplicaion from his roster.
...
;;professor-roster : ListOfSlip String -> ListOfSlip                  
;;GIVEN: a list of slips and the color of the slip.
;;RETURNS: a list of slips containing all the students in Professor's
;;roster, without duplication.
;;Strategy: Calling a more general function..
;;Example:
;;(professor-roster LOS-2 "yellow")
;;(list (make-slip "yellow" "Harsh" "Shukla"))

(define (professor-roster los str)
  (concat los empty str))
...
(define (concat los hans str)
  (cond
    [(empty? los) hans]
    [ (string=? (slip-color (first los)) str)
      (concat(rest los)(update-list (first los) hans) str)]
    [else (concat(rest los) hans str)]))


;;Tests:
(begin-for-test
  (check-equal?
   (concat los1 los2 "yellow")
   (list
    (make-slip "yellow" "Harry" "Potter")
    (make-slip "yellow" "Harsh" "Shukla")
    (make-slip "yellow" "John" "Nash"))
...
;;Example:
;;(update-list (make-slip "blue" "Harsh" "Singh") los1)
;;         (list
...
duplication in Prof.Felleisen's class")
 ...
 in Prof. Shiver's class")
  ...
  (check-equal?
   (professor-roster los1 "blue")
   (list
    (make-slip "blue" "shukla" "harsh")
    (make-slip "blue" "Harsh" "Singh")
    (make-slip "blue" "Harry" "Potter")
    (make-slip "blue" "Harsh" "Shukla"))
   "Should Return the list after eliminating duplication in Professors
class by using slip color"))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
